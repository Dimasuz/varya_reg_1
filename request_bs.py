...
def request_list(sites):
    ...
    req = request_url("https://shepkinskoe.ru/applicants/specialty/priem-2026/")
    soup = BeautifulSoup(req.text, "lxml")
    tag = soup.find("div", class_="float100")
    # tag = soup.find('Подробная информация о проведении творческих')
    print(tag)
